...
export const customEncounterParams =
  'custom:(encounterDatetime,uuid,location:(uuid,name),encounterType:(uuid),obs:(display,value:(uuid),groupMembers:(value:(uuid),concept:(datatype:(name),uuid),uuid),concept:(datatype:(name),uuid),uuid),patient:(uuid,identifiers:(identifier),person:(names:(givenName,familyName))),encounterProviders:(uuid,encounterRole:(uuid),provider:(uuid,person:(names:(givenName,familyName)))))';
